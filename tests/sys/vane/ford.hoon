...
++  test-marker-validate  ^-  tang
  ...
  ::
  =/  schematic=schematic:ford:marker
    (validate:marker [12 13] %foo [~nul %home])
  ::
  =^  results1  ford-gate
    %-  ford-call-with-comparator  :*
      ford-gate
      now=~1111.1.1
      scry=scry
      call-args=[duct=~[/validate] type=~ %build ~nul live=%.n schematic]
      ::
      ^=  comparator
        |=  moves=(list move:ford-gate)
        ^-  tang
...
++  test-marker-join  ^-  tang
  ...
  =/  scry
    ...
    %-  my  :~
      ...
      ++  grad
        |%
        ++  join  |=([first=[@tas @ud] second=[@tas @ud]] `second)
        ++  form  %bar
        --
      --
      '''
  ...
  =^  results1  ford-gate
    %-  ford-call-with-comparator  :*
      ...
      now=~1111.1.1
      scry=scry
      call-args=[duct=~[/join] type=~ %build ~nul live=%.n schematic]
      ::
      ^=  comparator
        |=  moves=(list move:ford-gate)
        ^-  tang
...
++  test-marker-mash  ^-  tang
  ...
  =/  scry
    ...
    %-  my  :~
      ...
      ++  grad
        |%
        ++  form  %bar
        ++  mash  |=  $:  a=[=ship =desk diff=[@tas @ud]]
                          b=[=ship =desk diff=[@tas @ud]]
                      ==
                  ^-  [@tas @ud]
                  ::
                  [-.diff.a +.diff.b]
  ...
  =^  results1  ford-gate
    %-  ford-call-with-comparator  :*
      ...
      now=~1111.1.1
      scry=scry
      call-args=[duct=~[/mash] type=~ %build ~nul live=%.n schematic]
      ::
      ^=  comparator
        |=  moves=(list move:ford-gate)
        ^-  tang
  ...
  =^  results1  ford-gate
    %-  ford-call-with-comparator  :*
      ...
      ^=  comparator
        ...
        ::
          %+  expect-eq
            !>  [%made ~1111.1.1 %complete %& !>([11 12 13])]
            !>  |4.i.moves
    ==  ==
  ::
  %+  welp
